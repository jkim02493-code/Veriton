...
const samples: WritingSample[] = [
  {
    ...
    domain: "history",
    text: `
      The rise of industrial warfare changed the relationship between governments and civilians. Although military leaders often described the conflict as a matter of strategy, the war also depended on factories, railroads, and public morale. This suggests that modern conflict cannot be understood only through battles. It must also be studied through the social systems that made those battles possible.
  ...
  },
  {
    ...
    text: `
      In the novel, the narrator's uncertainty reveals a larger conflict between memory and identity. The repeated image of the locked room might suggest that the character is afraid of confronting the past. Furthermore, the quiet setting makes the emotional tension feel more controlled and more painful.
  ...
  },
  {
    ...
    domain: "scientific",
    text: `
      The experiment shows that small changes in method can strongly affect the result. Because the sample size was limited, the conclusion should be treated carefully. The data may indicate a useful pattern, but it does not clearly prove a universal rule.
